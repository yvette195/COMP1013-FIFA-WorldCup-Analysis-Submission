...
Git and GitHub were used to manage the development of this project.

The GitHub repository is available at:

**https://github.com/yvette195/COMP1013-FIFA-WorldCup-Analysis**

Git was used to record changes made to the project. GitHub was used to store the repository online and maintain a history of the project development.
...
- `scripts/` contains the R scripts used for Questions 1 to 4.
- `report/` contains the R Markdown report.
- `figures/` contains images used in the report.
- `COMP1013-FIFA-WorldCup-Analysis.Rproj` is the RStudio project file.

This folder structure keeps the datasets, scripts, report and figures separate, making the project easier to understand and maintain.

## Commit History

```{r question-5-commit-history, echo=FALSE, out.width="100%"}
knitr::include_graphics("../figures/commit_history.png")
```

## Explanation of the Commit History

The commit history shows that I developed the project step by step. I did not upload all the work in only one commit.

1. **Initial commit**  
   This was the first commit used to start the repository.

2. **Create initial project structure**  
   This commit created the main folders for the project, including the data, scripts, report and figures folders.

3. **Set up RStudio project and report template**  
   This commit added the RStudio project file and the first R Markdown report template.

4. **Add FIFA World Cup datasets**  
   This commit added the four CSV datasets used for the assignment.

5. **Complete Question 1 data preparation and penalty analysis**  
   This commit added the data cleaning and penalty analysis for Question 1.

6. **Complete Questions 1 and 2 data analysis**  
   This commit added the main analysis for Questions 1 and 2.

7. **Simplify code and complete Questions 1 and 2**  
   This commit changed some code into simpler code and completed the first two questions.

8. **Change path of datasets**  
   This commit changed the dataset paths so the files could be read correctly from the report folder.

9. **Fix report paths and update Questions 1 and 2**  
   This commit fixed more file-path problems and updated the content for Questions 1 and 2.

10. **Complete Questions 3 and 4 analysis**  
    This commit added the penalty-shootout rankings and the match-outcome analysis.

11. **Complete Question 5 and final report**  
    This commit added the GitHub section, the commit-history screenshot and the first final PDF report.

12. **Revise explanations and update chart colours**  
    This commit rewrote the rationale and explanation sections using simpler English. It also changed the charts to use the same colour palette.

The commit messages show the main progress of my assignment. They also make it easier to understand what I changed at each stage.
\newpage